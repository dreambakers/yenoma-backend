module.exports = {
    messages: {
        verifyYourEmail: "Please verify your email _de",
        passwordResetRequestReceived: "Password reset request received _de",
        feedbackReceived: "Feedback received _de",
    ...
    labels: {
        resetPassword: "Reset Password _de",
        verify: "Verify _de"
    }
}